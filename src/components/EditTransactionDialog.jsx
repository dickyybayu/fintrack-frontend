...
function EditTransactionDialog({ open, onClose, onUpdate, transaction, wallets }) {
  ...
  const handleSaldoChange = (e) => {
    ...
    e.preventDefault();
    try {
        await onUpdate(transaction._id, form); 
        onClose(null);
    } catch (err) {
    ...
    if (transaction) {
        ...
        setSaldo(formatNumber(transaction.amount.toString()));
    }
    }, [transaction]);
